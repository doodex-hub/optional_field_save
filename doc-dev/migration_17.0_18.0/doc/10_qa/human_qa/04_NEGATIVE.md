...
|---|---|---|---|---|
| 2026-08-26 | Docker `odoo:18.0` + module, kombinasi (test Python otomatis + AI-interaktif) | AI (test suite + Claude Browser tool) | Pass | Bagian 1: `AccessError` terkonfirmasi test Python, tidak ada notifikasi UI dikonfirmasi baca kode. Bagian 2: key `optional_field.*` terhapus, key lain tidak tersentuh — dikonfirmasi panggil langsung callback logout item |
