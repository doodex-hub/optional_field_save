...
✅ **Step 5 — Acceptance Criteria & Test Plan selesai (2026-08-26).** Step 1-4 lulus. `05a` (7 kelompok AC, AC-01 s/d AC-07) dan `05b` (test plan step 9/10/11) ditulis — sebagian besar AC bersifat regression check (mekanisme sudah tervalidasi migrasi 17→18), 1 AC baru murni infra (AC-07-01, `groups_id`→`group_ids`). **Lanjut ke Step 6 (Code Migration) tanpa henti** sesuai prinsip "JALAN TERUS di CLI".
